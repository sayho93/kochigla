...
<?
    ...
    if(!AuthUtil::isLoggedIn() || $currentUser["isAdmin"] != 1)
        echo "<script>alert('접근 권한이 없습니다.');location.href='/mygift/admin';</script>";
?>
<!DOCTYPE html>
<html lang="ko">
...
<!--            <a class="navbar-brand brand-logo" href="index.php"><img src="../images/logo.svg" alt="logo"/></a>-->
            <a class="navbar-brand brand-logo jLink" target="pages"><img src="../images/icon_main_dark.png" alt="logo"/></a>

            <a class="navbar-brand brand-logo-mini jLink" target="pages"><img src="../images/logo-mini.svg" alt="logo"/></a>
        </div>
...
<!--                            <span class="availability-status online"></span>-->
                    ...
                    <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                        ...
                        <a class="dropdown-item jLogout" href="#">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="general-pages">4
                        <ul class="nav flex-column sub-menu">
...
<!--        <script src="https://cdnjs.cloudflare.com/ajax/libs/babel-core/5.6.15/browser-polyfill.min.js"></script>-->
        ...
        <link rel="stylesheet" type="text/css" href="../../shared/lib/filepond/filepond-plugin-image-preview.css" rel="stylesheet">

        <link href="../../shared/lib/filepond/filepond-plugin-file-poster.css" rel="stylesheet">
        <script src="../../shared/lib/filepond/filepond-plugin-file-poster.js"></script>
        ...
        <style>
            ...
            .filepond--drop-label{color : #777;}
            .filepond--drop-label label{color : #777;}
        </style>
        ...
        <script type="text/babel">
            ...
            $(document).ready(() => {
                ...
                $(".jLogout").click(() => {
                    callJson(
                        "/mygift/shared/public/route.php?F=UserAuthRoute.requestLogout", null,
                        (data) => {
                            if(data.returnCode === 1) callBackSwal("알림", data.returnMessage, "info", "");
                        }
                    )
                });

                $(".jLink").click((element) => {
                    transition(element.currentTarget.getAttribute("target"));
                });

                // GLOBAL
                window.transition = (target) => {
                  let url = `/mygift/admin/${target}`;
                  $("body").fadeOut();
                  setTimeout(() => {location.href = url;}, target);
                };

                window.callBackSwal = (title, text, icon, target) => {
                    swal({
                        title: title,
                        text: text,
                        icon: icon,
